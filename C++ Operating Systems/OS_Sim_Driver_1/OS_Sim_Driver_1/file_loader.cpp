	...
	//if (true)
	{
		...
		while(getline (myfile,line))
		{
			...
			if(line.substr(0,6) == "// JOB")
			{
				...
				frame_adjusted_code_size = 4 * (int)((sz/4.0) + 0.5);
				empty_line_count = frame_adjusted_code_size - sz;
				cout << "frame_adjusted_code_size= ";
				cout << frame_adjusted_code_size << endl;
#ifdef USING_FRAMES
				sz=frame_adjusted_code_size;
#endif
			...
			else if(line.substr(0,8) == "// Data ")
			{
				...
				raw_data_line_cnt+= empty_line_count;
#endif
