...
public:
	...
	int getIoReadCount(const int& pid){return pcb_array[pid].accounting.io_read_count;};
	int getIoWriteCount(const int& pid){return pcb_array[pid].accounting.io_write_count;};
	void incIoReadCount(const int&  pid){pcb_array[pid].accounting.io_read_count++;};
	void incIoWriteCount(const int&  pid){pcb_array[pid].accounting.io_write_count++;};
	void setIoReadCount(const int&  pid, const int& value){pcb_array[pid].accounting.io_read_count = value;};
	void setIoWriteCount(const int&  pid, const int& value){pcb_array[pid].accounting.io_write_count = value;};

	int getCacheHitCount(const int& pid){return pcb_array[pid].accounting.cache_hit_count;};
	void setCacheHitCount(const int&  pid, const int& value){pcb_array[pid].accounting.cache_hit_count = value;};
	void incCacheHitCount(const int&  pid){pcb_array[pid].accounting.cache_hit_count++;};
	int getCacheMissCount(const int& pid){return pcb_array[pid].accounting.cache_miss_count;};
	void setCacheMissCount(const int&  pid, const int& value){pcb_array[pid].accounting.cache_miss_count = value;};
	void incCacheMissCount(const int&  pid){pcb_array[pid].accounting.cache_miss_count++;};
	int getCacheUsed(const int& pid){return pcb_array[pid].accounting.cache_used;};
	void setCacheUsed(const int&  pid, const int& value){pcb_array[pid].accounting.cache_used = value;};
	void incCacheUsed(const int&  pid){pcb_array[pid].accounting.cache_used++;};
