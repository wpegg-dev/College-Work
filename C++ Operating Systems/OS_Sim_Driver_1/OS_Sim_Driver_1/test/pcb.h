...
public:
	...
	int getIoReadCount(const int& pid){return pcb_array[pid].io_read_count;};
	int getIoWriteCount(const int& pid){return pcb_array[pid].io_write_count;};
	void incIoReadCount(const int&  pid){pcb_array[pid].io_read_count++;};
	void incIoWriteCount(const int&  pid){pcb_array[pid].io_write_count++;};
	void setIoReadCount(const int&  pid, const int& value){pcb_array[pid].io_read_count = value;};
	void setIoWriteCount(const int&  pid, const int& value){pcb_array[pid].io_write_count = value;};
